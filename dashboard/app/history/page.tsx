...
export default function AnalyticsDashboard() {
    ...
    if (isLoading) {
        return (
            <div className="h-full w-full flex flex-col p-2 md:p-4 lg:p-6 pb-24 md:pb-6 relative overflow-hidden bg-black">
                {/* Aurora Background */}
                ...
                >
                    ...
                    <div className="w-[300px] h-full glass-card rounded-[40px] p-8 hidden lg:flex flex-col gap-8 bg-white/5 animate-pulse border border-white/5">
                        <div className="h-12 w-3/4 bg-white/10 rounded-xl" />
                        <div className="space-y-4">
                            {[1, 2, 3, 4].map(i => (
                                <div key={i} className="h-12 w-full bg-white/5 rounded-[24px]" />
                            ))}
                        </div>
                    </div>
